          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                {attendees.length} {attendees.length === 1 ? 'student' : 'students'} registered
              </p>
            </div>
            <button
          ...
          <div style={{
            ...
            {attendees.length === 0 ? (
              <div style={{
                ...
                <h4 style={{ margin: '0 0 8px 0', color: '#9ca3af' }}>No Students Yet</h4>
                <p style={{ margin: 0, fontSize: '14px' }}>
                  Share the exam key <strong>{examKey}</strong> with students to get started
                </p>
              </div>
            ) : (
                ...
                {attendees.map((attendance: any, index: number) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: '16px 24px',
                        borderBottom: index < attendees.length - 1 ? '1px solid rgba(255, 255, 255, 0.05)' : 'none',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '12px',
